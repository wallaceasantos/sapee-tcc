...
def calcular_risco_evasao(aluno_data, db=None):
    ...
    fatores = []
    if aluno_data.frequencia < 80:
        fatores.append("Frequência crítica")
    if aluno_data.media_geral < 6:
        fatores.append("Desempenho acadêmico instável")
...
def fallback_logic(aluno_data, db=None):
    ...
    if aluno_data.trabalha:
        if aluno_data.carga_horaria_trabalho and aluno_data.carga_horaria_trabalho > 40:
            score += 15
            fatores.append(
                f"Trabalha em tempo integral ({aluno_data.carga_horaria_trabalho}h/semana)"
            )
    ...
    return {
        ...
        "nivel_risco": (
            ...
            if score > 70
            else models.NivelRisco.MEDIO if score > 30 else models.NivelRisco.BAIXO
        ),
        "fatores_principais": (
    ...
    return [
        {
            ...
            "perguntas": [
                {
                    "id": "q1_ansiedade",
                    "texto": "Sinto ansiedade frequente relacionada aos estudos",
                },
                ...
                {
                    "id": "q4_sono",
                    "texto": "Tenho tido dificuldades para dormir por preocupações com a escola",
                },
                {
                    "id": "q5_bem_estar",
                    "texto": "Me sinto bem emocionalmente para estudar",
                    "invertida": True,
                },
            ],
        },
        {
            ...
            "perguntas": [
                ...
                {
                    "id": "q8_participacao",
                    "texto": "Participo de atividades extracurriculares da escola",
                },
                {
                    "id": "q9_relacionamento_professores",
                    "texto": "Tenho bom relacionamento com os professores",
                },
                {
                    "id": "q10_apoio_colegas",
                    "texto": "Posso contar com colegas para dificuldades acadêmicas",
                },
            ],
        },
        {
            ...
            "perguntas": [
                ...
                {
                    "id": "q14_conteudo_programatico",
                    "texto": "O conteúdo programático é relevante para mim",
                },
        ...
        },
        {
            ...
            "perguntas": [
                ...
                {
                    "id": "q17_familia_estudo",
                    "texto": "Minha família apoia meus estudos",
                    "invertida": True,
                },
                {
                    "id": "q18_tempo_lazer",
                    "texto": "Tenho tempo para lazer e descanso",
                    "invertida": True,
                },
                {"id": "q19_cansaco", "texto": "Sinto cansaço excessivo no dia a dia"},
                {
                    "id": "q20_sobrecarga",
                    "texto": "Me sinto sobrecarregado(a) de responsabilidades",
                },
            ],
        },
        {
            ...
            "perguntas": [
                ...
                {
                    "id": "q22_frequencia_pensamento",
                    "texto": "Com que frequência penso em abandonar o curso",
                },
                {
                    "id": "q23_motivacao_permanencia",
                    "texto": "Estou motivado(a) a permanecer no curso",
                    "invertida": True,
                },
