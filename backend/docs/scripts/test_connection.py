...
try:
    ...
    conn_server = mysql.connector.connect(host=host, port=port, user=user, password=password)
    ...
    if not db_exists:
        ...
        print("\n  Opção 2: Terminal")
        print(
            f'    mysql -u{user} -p -e "CREATE DATABASE sapee_dewas CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;"'
        )
