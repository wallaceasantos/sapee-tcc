...
def testar_calculo_risco():
    ...
    print("-" * 80)
    print(
        f"SCORE TOTAL:               {resultado_muito_alto['score_psicossocial_total']:.2f} / 100"
    )
    ...
    print("-" * 80)
    print(
        f"{'Baixo Risco':<20} {resultado_baixo['score_psicossocial_total']:<15.2f} {resultado_baixo['nivel_risco_psicossocial']:<15} +{resultado_baixo['bonus_risco_modelo']:<14}"
    )
    print(
        f"{'Médio Risco':<20} {resultado_medio['score_psicossocial_total']:<15.2f} {resultado_medio['nivel_risco_psicossocial']:<15} +{resultado_medio['bonus_risco_modelo']:<14}"
    )
    print(
        f"{'Alto Risco':<20} {resultado_alto['score_psicossocial_total']:<15.2f} {resultado_alto['nivel_risco_psicossocial']:<15} +{resultado_alto['bonus_risco_modelo']:<14}"
    )
    print(
        f"{'Muito Alto Risco':<20} {resultado_muito_alto['score_psicossocial_total']:<15.2f} {resultado_muito_alto['nivel_risco_psicossocial']:<15} +{resultado_muito_alto['bonus_risco_modelo']:<14}"
    )
    print()
