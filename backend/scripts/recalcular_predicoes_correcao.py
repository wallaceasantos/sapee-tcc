...
def recalcular_predicoes():
    ...
    try:
        ...
        print(
            f"  🟢 BAIXO:       {estatisticas['baixo']:3d} alunos ({estatisticas['baixo']/estatisticas['total']*100:5.1f}%)"
        )
        print(
            f"  🟡 MÉDIO:       {estatisticas['medio']:3d} alunos ({estatisticas['medio']/estatisticas['total']*100:5.1f}%)"
        )
        print(
            f"  🔴 ALTO:        {estatisticas['alto']:3d} alunos ({estatisticas['alto']/estatisticas['total']*100:5.1f}%)"
        )
        print(
            f"  🟣 MUITO ALTO:  {estatisticas['muito_alto']:3d} alunos ({estatisticas['muito_alto']/estatisticas['total']*100:5.1f}%)"
        )
        print("=" * 80)
