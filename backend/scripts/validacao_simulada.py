...
from ml_logic_v2 import fallback_logic_v2
...
ALUNOS_TESTE = [
    # RISCO BAIXO - 6 alunos esperados
    {
        ...
        "matricula": "2026102001",
        "label_esperado": "BAIXO",
        "media": 8.5,
        "freq": 92.5,
        "reprovas": 0,
        "renda": 4500,
    ...
    {
        "nome": "Pedro Rodrigues Costa",
        "matricula": "2026102004",
        "label_esperado": "BAIXO",
        "media": 6.8,
        "freq": 82.0,
        "reprovas": 1,
    ...
    {
        "nome": "Francisca Oliveira Costa",
        "matricula": "2026102005",
        "label_esperado": "BAIXO",
        "media": 7.5,
        "freq": 87.5,
        "reprovas": 0,
    ...
    {
        "nome": "Luiz Araújo Nunes",
        "matricula": "2026102006",
        "label_esperado": "BAIXO",
        "media": 8.0,
        "freq": 90.0,
        "reprovas": 0,
    ...
    {
        "nome": "Antônio Souza Oliveira",
        "matricula": "2026102007",
        "label_esperado": "MEDIO",
        "media": 5.8,
        "freq": 72.5,
        "reprovas": 2,
        "renda": 2800,
    ...
    {
        "nome": "Joana Rodrigues Souza",
        "matricula": "2026102008",
        "label_esperado": "MEDIO",
        "media": 6.2,
        "freq": 75.0,
        "reprovas": 2,
    ...
    {
        "nome": "Carlos Mendes Duarte",
        "matricula": "2026102009",
        "label_esperado": "ALTO",
        "media": 5.5,
        "freq": 70.0,
        "reprovas": 3,
    ...
    {
        "nome": "Josefa Barbosa Nunes",
        "matricula": "2026102010",
        "label_esperado": "ALTO",
        "media": 5.0,
        "freq": 68.5,
        "reprovas": 3,
    ...
    {
        "nome": "Raimunda Mendes Duarte",
        "matricula": "2026102012",
        "label_esperado": "ALTO",
        "media": 5.2,
        "freq": 70.5,
        "reprovas": 2,
    ...
    {
        "nome": "Sebastião Oliveira Santos",
        "matricula": "2026102013",
        "label_esperado": "ALTO",
        "media": 4.2,
        "freq": 65.0,
        "reprovas": 4,
    ...
    {
        "nome": "Teresa Lima Rodrigues",
        "matricula": "2026102014",
        "label_esperado": "ALTO",
        "media": 4.5,
        "freq": 68.0,
        "reprovas": 3,
    ...
    # MUITO ALTO - 6 alunos esperados
    {
        ...
        "matricula": "2026102015",
        "label_esperado": "MUITO_ALTO",
        "media": 3.5,
        "freq": 58.0,
        "reprovas": 4,
        "renda": 900,
    ...
    {
        "nome": "Antônia Pereira Lima",
        "matricula": "2026102016",
        "label_esperado": "MUITO_ALTO",
        "media": 3.8,
        "freq": 55.0,
        "reprovas": 5,
    ...
    {
        "nome": "José Barbosa Rocha",
        "matricula": "2026102017",
        "label_esperado": "MUITO_ALTO",
        "media": 3.2,
        "freq": 52.0,
        "reprovas": 5,
    ...
    {
        "nome": "Pedro Ferreira Rocha",
        "matricula": "2026102018",
        "label_esperado": "MUITO_ALTO",
        "media": 2.8,
        "freq": 48.0,
        "reprovas": 6,
    ...
    {
        "nome": "Sebastiana Araújo Santos",
        "matricula": "2026102020",
        "label_esperado": "MUITO_ALTO",
        "media": 2.2,
        "freq": 42.0,
        "reprovas": 8,
...
def validar_fallback():
    ...
    for aluno_data in ALUNOS_TESTE:
        ...
        nivel_predito = (
            ...
            if hasattr(resultado["nivel_risco"], "value")
            else str(resultado["nivel_risco"])
        )
    ...
    for i, r in enumerate(resultados, 1):
        ...
        print(
            f"{i:<3} {r['nome']:<30} {r['label_esperado']:<12} {r['nivel_predito']:<12} {r['score_predito']:>6}% {status_icon} {r['tipo_acerto']}"
        )
    ...
    tp = sum(
        1
        for r in resultados
        if r["label_esperado"] in ["ALTO", "MUITO_ALTO"]
        and r["nivel_predito"] in ["ALTO", "MUITO_ALTO"]
    )
    fp = sum(
        1
        for r in resultados
        if r["label_esperado"] not in ["ALTO", "MUITO_ALTO"]
        and r["nivel_predito"] in ["ALTO", "MUITO_ALTO"]
    )
    fn = sum(
        1
        for r in resultados
        if r["label_esperado"] in ["ALTO", "MUITO_ALTO"]
        and r["nivel_predito"] not in ["ALTO", "MUITO_ALTO"]
    )
    tn = sum(
        1
        for r in resultados
    ...
    print(
        f"Acertos amplos (±1):      {acertos_exatos + acertos_adjacentes}/{total} ({acuracia_ampla*100:.1f}%)"
    )
    ...
    if acuracia_ampla >= 0.8:
        ...
        print(
            "⚠️  PARCIALMENTE CONSISTENTE: Fallback tem acertos mas com margem de erro significativa."
        )
    else:
    ...
    if erros > 0:
        ...
        for r in resultados:
            if not r["acerto"]:
                print(
                    f"  ❌ {r['nome']}: Esperava {r['label_esperado']}, predito {r['nivel_predito']}"
                )
